...
sdt$term_1 <- stri_extract_first(sdt$terms, regex="^[a-z]+_[a-z]+_[a-z]+_[a-z]+_[a-z]+(?=_)")
...
spdt$term_1 <- stri_extract_first(spdt$terms, regex="^[a-z]+_[a-z]+_[a-z]+_[a-z]+_[a-z]+_[a-z]+(?=_)")
